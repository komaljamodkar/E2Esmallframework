...
public class LoadingFailedInternetoff {
	...
	public static void main(String[] args) {
		...
		try {
			...
			devtool.send(Network.emulateNetworkConditions(true, 3000, 20000, 30000, Optional.of(ConnectionType.CELLULAR4G)));
				//check network speed
...
//			devtool.addListener(Network.loadingFinished(), clearc->{
//				clearc.getTimestamp();
//			});
